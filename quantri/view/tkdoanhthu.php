...
?>
    <main class="content">
        ...
        <!-- Sửa thành tkdoanhthu -->
        <input type="hidden" name="page" value="tkdoanhthu">
        ...
        <div id="thongke-container" class="doanhthu">
            <?php
                if(isset($_GET['time']) && isset($_GET['report'])) {
                    ...
                    if ($time == 'thang') {
                        ...
                        echo '
                            <table class="thongke-table doanhthu" border="2px">
                                <tr class="title doanhthu">
                        ...
                        echo "    
                                <tr class='table-data sum-row'>
                                    <td colspan='3' class='doanhthu' id='sum-cell'>TỔNG:</td>
                    ...
                    echo "
                        <button class='thongke-button print-btn doanhthu' type='submit' id='inthongke'>
                            <i class='fa-solid fa-print'></i>";
                            if(isset($_GET['time']) && isset($_GET['report'])) {
                                $time = $_GET['time'];
                                if ($time == 'thang') {
                                    $date = $_GET['thang'];
                                    echo "<a href='../controller/printReports.php?time=thang&report=doanhthu&thang=$date'>In thống kê</a>";
                                } 
                                else if ($time == 'nam'){
                                    $year = $_GET['nam'];
                                    echo "<a href='../controller/printReports.php?time=nam&report=doanhthu&nam=$year'>In thống kê</a>";
                                }
                            }
                            else {

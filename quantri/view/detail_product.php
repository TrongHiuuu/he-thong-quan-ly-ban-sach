...
<div class="formPopup" id="view-modal-product">
    <form action="#" method="post" id="view-form-product">
        <button type="button" class="close-btn close-btn-product"><i class="fa-solid fa-x"></i></button>
        <div class="change_img">
            <img src="#" alt="productImage" id="view_pic">
        </div>
        <div class="info">
            ...
            <div class="field">
                ...
                <input type="text" name="idNCC" disabled>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <input type="text" name="idTL" disabled>
            </div>
            <div class="field">
                <label for="idMGG">Giảm giá (%)</label>
                <input type="text" name="idMGG" disabled>
            </div>
            <div class="status">
            ...
            <div class="field">
                ...
                <textarea name="mota" cols="50" rows="5" disabled></textarea>
            </div>
        </div>
    </form>
</div>

...
const errorMessageCurrentPassword = document.querySelector(".errorMessage_infor_currentPassword");
...
$(document).ready(function () {
    $("#info_form").submit(function (e) {
        ...
        if (validateInfoForm()) {
            ...
            $.ajax({
                url: "controller/customerinfo.php",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    if(obj.success) {
                        $('.alert').html('<span class="green">Thay đổi thông tin cá nhân thành công</span>');
                        location.reload();
                    };
                },
            });
